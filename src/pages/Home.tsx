      ...
      <section className="hero1">
        <div className="left-side">
          ...
          <p className="description">
            I’m a 4th year computer engineering student interested in building responsive, accessible, and visually comprehensive web experiences.
          </p>
        </div>
          ...
          <section className="about" id="about">
           <h2>About Me</h2>
            <section className="about" id="about">
                ...
                <p className="aboutp">
                  Currently, I’m a Computer Engineering student actively exploring opportunities to grow as a developer. I’ve worked on projects using React + TypeScript for the frontend and Spring Boot for the backend, including an inventory management system website, a playdate application, and several university course projects.
                </p>
                <p className="aboutp">
